...
<form class="layui-form" >
    ...
    <div class="layui-input-block">
      <select name="pyfa" lay-filter="pyfa">
  ...
  <div class="layui-form-item" style="width:30%;float:left;margin-left:60%;margin-top:-53px;">
...
<div id="yc1"  style="width:1006px;height:580px;margin-left:15px;margin-top:5px;">
		...
		<div name="xq1s"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;">
			<div onclick="xk('0','xq1s1')" name="xq1s1"style="box-sizing:border-box;width:15.75px;height:30px;float:left;border-right:0.5px solid black;"></div>
			<div onclick="xk('0','xq1s2')" name="xq1s2"style="width:15.75px;height:30px;float:left;"></div>
		</div>
		<div name="xq1x"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;">
			<div onclick="xk('0','xq1x1')"name="xq1x1"style="box-sizing:border-box;border-right:0.5px solid black;width:15.75px;height:30px;float:left;"></div>
			<div onclick="xk('0','xq1x2')"name="xq1x2"style="width:15.75px;height:30px;float:left;"></div>
		</div>
		<div onclick="xk2('0','xq1w')"name="xq1w"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;"></div>	
		...
		<div name="xq2s"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;">
			<div onclick="xk('0','xq2s1')"name="xq2s1"style="box-sizing:border-box;border-right:0.5px solid black;width:15.75px;height:30px;float:left;"></div>
			<div onclick="xk('0','xq2s2')"name="xq2s2"style="width:15.75px;height:30px;float:left;"></div>
		</div>
		<div name="xq2x"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;">
			<div onclick="xk('0','xq2x1')"name="xq2x1"style="box-sizing:border-box;border-right:0.5px solid black;width:15.75px;height:30px;float:left;"></div>
			<div onclick="xk('0','xq2x2')"name="xq2x2"style="width:15.75px;height:30px;float:left;"></div>
		</div>
		<div onclick="xk2('0','xq2w')"name="xq2w"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;"></div>	
		...
		<div name="xq3s"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;">
			<div onclick="xk('0','xq3s1')"name="xq3s1"style="box-sizing:border-box;border-right:0.5px solid black;width:15.75px;height:30px;float:left;"></div>
			<div onclick="xk('0','xq3s2')"name="xq3s2"style="width:15.75px;height:30px;float:left;"></div>
		</div>
		<div name="xq3x"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;">
			<div onclick="xk('0','xq3x1')"name="xq3x1"style="box-sizing:border-box;border-right:0.5px solid black;width:15.75px;height:30px;float:left;"></div>
			<div onclick="xk('0','xq3x2')"name="xq3x2"style="width:15.75px;height:30px;float:left;"></div>
		</div>
		<div onclick="xk2('0','xq3w')"name="xq3w"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;"></div>	
		...
		<div name="xq4s"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;">
			<div onclick="xk('0','xq4s1')" name="xq4s1"style="box-sizing:border-box;border-right:0.5px solid black;width:15.75px;height:30px;float:left;"></div>
			<div onclick="xk('0','xq4s2')" name="xq4s2"style="width:15.75px;height:30px;float:left;"></div>
		</div>
		<div name="xq4x"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;">
			<div onclick="xk('0','xq4x1')"name="xq4x1"style="box-sizing:border-box;border-right:0.5px solid black;width:15.75px;height:30px;float:left;"></div>
			<div onclick="xk('0','xq4x2')"name="xq4x2"style="width:15.75px;height:30px;float:left;"></div>
		</div>
		<div onclick="xk2('0','xq4w')"name="xq4w"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;"></div>		
		...
		<div name="xq5s"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;">
			<div onclick="xk('0','xq5s1')"name="xq5s1"style="box-sizing:border-box;border-right:0.5px solid black;width:15.75px;height:30px;float:left;"></div>
			<div onclick="xk('0','xq5s2')"name="xq5s2"style="width:15.75px;height:30px;float:left;"></div>
		</div>
		<div name="xq5x"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;">
			<div onclick="xk('0','xq5x1')"name="xq5x1"style="box-sizing:border-box;border-right:0.5px solid black;width:15.75px;height:30px;float:left;"></div>
			<div onclick="xk('0','xq5x2')"name="xq5x2"style="width:15.75px;height:30px;float:left;"></div>
		</div>
		<div onclick="xk2('0','xq5w')"name="xq5w"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;"></div>
		...
		<div name="xq6s"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;">
			<div onclick="xk('0','xq6s1')"name="xq6s1"style="box-sizing:border-box;border-right:0.5px solid black;width:15.75px;height:30px;float:left;"></div>
			<div onclick="xk('0','xq6s2')"name="xq6s2"style="width:15.75px;height:30px;float:left;"></div>
		</div>
		<div name="xq6x"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;">
			<div onclick="xk('0','xq6x1')"name="xq6x1"style="box-sizing:border-box;border-right:0.5px solid black;width:15.75px;height:30px;float:left;"></div>
			<div onclick="xk('0','xq6x2')"name="xq6x2"style="width:15.75px;height:30px;float:left;"></div>
		</div>
		<div onclick="xk2('0','xq6w')"name="xq6w"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;"></div>
		...
		<div name="xq7s"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;">
			<div onclick="xk('0','xq7s1')"name="xq7s1"style="box-sizing:border-box;border-right:0.5px solid black;width:15.75px;height:30px;float:left;"></div>
			<div onclick="xk('0','xq7s2')"name="xq7s2"style="width:15.75px;height:30px;float:left;"></div>
		</div>
		<div name="xq7x"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;">
			<div onclick="xk('0','xq7x1')"name="xq7x1"style="box-sizing:border-box;border-right:0.5px solid black;width:15.75px;height:30px;float:left;"></div>
			<div onclick="xk('0','xq7x2')"name="xq7x2"style="width:15.75px;height:30px;float:left;"></div>
		</div>
		<div onclick="xk2('0','xq7w')"name="xq7w"style="float:left;width:31.5px;height:30px;text-align:center;font-size:12px;"></div>
		...
		<div name="xingqi1"style="line-height:30px;float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;"></div>
		<div name="xq1s"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;">
			<div onclick="xk('1','xq1s1')" name="xq1s1"style="box-sizing:border-box;width:15.75px;height:30px;float:left;border-right:0.5px solid black;"></div>
			<div onclick="xk('1','xq1s2')" name="xq1s2"style="width:15.75px;height:30px;float:left;"></div>
		</div>
		<div name="xq1x"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;">
			<div onclick="xk('1','xq1x1')"name="xq1x1"style="box-sizing:border-box;border-right:0.5px solid black;width:15.75px;height:30px;float:left;"></div>
			<div onclick="xk('1','xq1x2')"name="xq1x2"style="width:15.75px;height:30px;float:left;"></div>
		</div>
		<div onclick="xk2('1','xq1w')"name="xq1w"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;"></div>	

		<div name="xingqi2"style="line-height:30px;float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;"></div>
		<div name="xq2s"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;">
			<div onclick="xk('1','xq2s1')"name="xq2s1"style="box-sizing:border-box;border-right:0.5px solid black;width:15.75px;height:30px;float:left;"></div>
			<div onclick="xk('1','xq2s2')"name="xq2s2"style="width:15.75px;height:30px;float:left;"></div>
		</div>
		<div name="xq2x"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;">
			<div onclick="xk('1','xq2x1')"name="xq2x1"style="box-sizing:border-box;border-right:0.5px solid black;width:15.75px;height:30px;float:left;"></div>
			<div onclick="xk('1','xq2x2')"name="xq2x2"style="width:15.75px;height:30px;float:left;"></div>
		</div>
		<div onclick="xk2('1','xq2w')"name="xq2w"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;"></div>	

		<div name="xingqi3"style="line-height:30px;float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;"></div>
		<div name="xq3s"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;">
			<div onclick="xk('1','xq3s1')"name="xq3s1"style="box-sizing:border-box;border-right:0.5px solid black;width:15.75px;height:30px;float:left;"></div>
			<div onclick="xk('1','xq3s2')"name="xq3s2"style="width:15.75px;height:30px;float:left;"></div>
		</div>
		<div name="xq3x"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;">
			<div onclick="xk('1','xq3x1')"name="xq3x1"style="box-sizing:border-box;border-right:0.5px solid black;width:15.75px;height:30px;float:left;"></div>
			<div onclick="xk('1','xq3x2')"name="xq3x2"style="width:15.75px;height:30px;float:left;"></div>
		</div>
		<div onclick="xk2('1','xq3w')"name="xq3w"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;"></div>	

		<div name="xingqi4"style="line-height:30px;float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;"></div>
		<div name="xq4s"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;">
			<div onclick="xk('1','xq4s1')" name="xq4s1"style="box-sizing:border-box;border-right:0.5px solid black;width:15.75px;height:30px;float:left;"></div>
			<div onclick="xk('1','xq4s2')" name="xq4s2"style="width:15.75px;height:30px;float:left;"></div>
		</div>
		<div name="xq4x"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;">
			<div onclick="xk('1','xq4x1')"name="xq4x1"style="box-sizing:border-box;border-right:0.5px solid black;width:15.75px;height:30px;float:left;"></div>
			<div onclick="xk('1','xq4x2')"name="xq4x2"style="width:15.75px;height:30px;float:left;"></div>
		</div>
		<div onclick="xk2('1','xq4w')"name="xq4w"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;"></div>		

		<div name="xingqi5"style="line-height:30px;float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;"></div>
		<div name="xq5s"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;">
			<div onclick="xk('1','xq5s1')"name="xq5s1"style="box-sizing:border-box;border-right:0.5px solid black;width:15.75px;height:30px;float:left;"></div>
			<div onclick="xk('1','xq5s2')"name="xq5s2"style="width:15.75px;height:30px;float:left;"></div>
		</div>
		<div name="xq5x"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;">
			<div onclick="xk('1','xq5x1')"name="xq5x1"style="box-sizing:border-box;border-right:0.5px solid black;width:15.75px;height:30px;float:left;"></div>
			<div onclick="xk('1','xq5x2')"name="xq5x2"style="width:15.75px;height:30px;float:left;"></div>
		</div>
		...
		<div name="xingqi1"style="line-height:30px;float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;"></div>
		<div name="xq1s"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;">
			<div onclick="xk('2','xq1s1')" name="xq1s1"style="box-sizing:border-box;width:15.75px;height:30px;float:left;border-right:0.5px solid black;"></div>
		...
		<div name="xingqi1"style="line-height:30px;float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;"></div>
		<div name="xq1s"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;">
			<div onclick="xk('3','xq1s1')" name="xq1s1"style="box-sizing:border-box;width:15.75px;height:30px;float:left;border-right:0.5px solid black;"></div>
		...
		<div name="xingqi1"style="line-height:30px;float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;"></div>
		<div name="xq1s"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;">
			<div onclick="xk('4','xq1s1')" name="xq1s1"style="box-sizing:border-box;width:15.75px;height:30px;float:left;border-right:0.5px solid black;"></div>
...
<div name="xingqi1"style="line-height:30px;float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;"></div>
	...
	<div name="xingqi1"style="line-height:30px;float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;"></div>
		...
		<div name="xingqi1"style="line-height:30px;float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;"></div>
		<div name="xq1s"style="float:left;width:31.5px;height:30px;border-right:0.5px solid black;text-align:center;font-size:12px;">
			<div onclick="xk('28','xq1s1')" name="xq1s1"style="box-sizing:border-box;width:15.75px;height:30px;float:left;border-right:0.5px solid black;"></div>
...
function ts(){
    ...
    var kcm1=document.getElementsByName("kcm")[0].value.trim();
    var strs= new Array(); 
    strs=kcm1.split("--");
    kcm=strs[1];
...
{ 
 ...
 function xk(id,str){
	 var kcm1=document.getElementsByName("kcm")[0].value;
	 var room=document.getElementsByName("room")[0].value;
	 if(kcm1=="-1"||room=="-1"){
		 layer.msg("请选择课程和实验室!", {icon: 5});
	 }
	 else{
		 var strs= new Array(); 
		  strs=kcm1.split("--");
    ...
    window.location.href="xk?kcm="+kcm+"&kcbh="+kcbh+"&room="+room+"&str="+str+"&id="+id;
	 }
