...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 4%;">
  <legend style="margin-left:40%;"><font color="blue" size="5">实习生</font></legend>
</fieldset>
	 		    ...
	 		    table.reload('testReload', {
				  ...
				  ,newUser: function(){
					  layer.open({
						  ...
						  shade: 0.8,
						  area: ['800px', '90%'],
						  content: 'istudentAdd' //iframe的url
