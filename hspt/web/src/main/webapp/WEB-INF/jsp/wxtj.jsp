...
function sc(){
   ...
   if(zid==-1&&sj==""){
	   $.get('device/wxtj').done(function (data) {
    ...
    if(zid!=-1&&sj==""){
 	   ...
 	   $.post('device/wxtj1',{zid:zid}).done(function (data) {
    ...
    if(zid=="-1"&&sj!=""){
    	$.post('device/wxtj3',{sj:sj}).done(function (data) {
    ...
    if(zid!="-1"&&sj!=""){
    	$.post('device/wxtj2',{cs:sj+"!"+zid}).done(function (data) {
