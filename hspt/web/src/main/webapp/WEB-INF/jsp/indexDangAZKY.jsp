...
<body background="image/b5.jpg">
        ...
        <div class="container">
            <div class="navbar-header">
             ...
             <div align="right" style="margin-top: 20px" ><font  >欢迎您，尊敬的档案质控员 ${user.name}</font></div>
	...
	<ul id="solutionList" class="clearfix">
		<li>
			<div class="solution-item-wrapper solution-item-01">
				...
				<p class="solution-title">科室人员档案管理</p>
				
				<div class="short-bar"></div>
				<a href="/web/managerUserInfo" class="common" style="position:relative;top:200px;left:162px; text-decoration:none; color:white; font-size:16px; cursor:pointer;">科室人员基本信息</a>
				<a href="/web/wexperienceSearch" class="common" style="position:relative;top:200px;left:162px; text-decoration:none; color:white; font-size:16px; cursor:pointer;">工作经历管理</a>
				<a href="/web/eexperienceSearch" class="common" style="position:relative;top:200px;left:162px; text-decoration:none; color:white; font-size:16px; cursor:pointer;">进修经历管理</a>
				<a href="/web/tecourseSearch" class="common" style="position:relative;top:200px;left:162px; text-decoration:none; color:white; font-size:16px; cursor:pointer;">教学经历管理</a>
				<a href="/web/parttimeSearch" class="common" style="position:relative;top:200px;left:162px; text-decoration:none; color:white; font-size:16px; cursor:pointer;">社会兼职管理</a>
				<a href="/web/cardSearch2" class="common" style="position:relative;top:200px;left:162px; text-decoration:none; color:white; font-size:16px; cursor:pointer;">证书管理</a>	
	            <a href="/web/awardSearch" class="common" style="position:relative;top:200px;left:162px; text-decoration:none; color:white; font-size:16px; cursor:pointer;">奖励管理</a>
	            <a href="/web/fworkSearch" class="common" style="position:relative;top:200px;left:162px; text-decoration:none; color:white; font-size:16px; cursor:pointer;">著作管理</a>			</div>
		</li>
		
		<li>
			<div class="solution-item-wrapper solution-item-02">
				<p class="solution-title">科室学术活动管理</p>
				<div class="short-bar"></div>
				<a  href="/web/meetingSearch" class="common" style="position:relative;top:223px;left:162px; text-decoration:none; color:white; font-size:16px; cursor:pointer;">举办会议</a>
				<a  href="/web/baseteachSearch" class="common" style="position:relative;top:223px;left:162px; text-decoration:none; color:white; font-size:16px; cursor:pointer;">基层巡讲</a>
				<a  href="/web/meetingspokenSearch" class="common" style="position:relative;top:223px;left:162px; text-decoration:none; color:white; font-size:16px; cursor:pointer;">大会发言</a>
				<a  href="/web/expertguidanceSearch" class="common" style="position:relative;top:223px;left:162px; text-decoration:none; color:white; font-size:16px; cursor:pointer;">专家指导</a>
				<a  href="/web/attendancerecordsSearch" class="common" style="position:relative;top:223px;left:162px; text-decoration:none; color:white; font-size:16px; cursor:pointer;">参会记录</a>
			
			</div>
		</li>
		<li  class="active">
			<div class="solution-item-wrapper solution-item-03">
				<p class="solution-title">基层进修管理</p>
				<div class="short-bar"></div>
			    <a  href="/web/basicSearch" class="common" style="position:relative;top:223px;left:162px; text-decoration:none; color:white; font-size:16px; cursor:pointer;">基层进修人员</a>
			   	<a  href="/web/rdoctorSearch" class="common" style="position:relative;top:223px;left:162px; text-decoration:none; color:white; font-size:16px; cursor:pointer;">住院医师</a>
				<a  href="/web/gstudentSearch" class="common" style="position:relative;top:223px;left:162px; text-decoration:none; color:white; font-size:16px; cursor:pointer;">研究生</a>
				<a  href="/web/istudentSearch" class="common" style="position:relative;top:223px;left:162px; text-decoration:none; color:white; font-size:16px; cursor:pointer;">实习生</a>
			</div>
		</li>
		<li>
