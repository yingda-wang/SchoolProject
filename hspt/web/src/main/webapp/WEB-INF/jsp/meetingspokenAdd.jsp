...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 4%;">
  <legend style="margin-left:40%;"><font size="5" color="blue">添加会议演讲</font></legend>
</fieldset>
<form class="layui-form" action="meetingspoken/add" method="post" >
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input class="layui-input" id="date2" type="text" name="holdTime" placeholder="yyyy-MM-dd">
      </div>
    </div>
  </div>
  <div class="layui-form-item">
  ...
  <div class="layui-form-item">
    <label class="layui-form-label">发言人员</label>
    <div class="layui-input-inline">
      <input type="text" name="spokeMan" required lay-verify="required"  class="layui-input">
    </div>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label">发言题目</label>
    <div class="layui-input-inline">
  ...
  <div class="layui-form-item">
			...
			<div class="layui-input-inline">
			<a name="courseSave"> </a>
<!-- 				<input type="text"  size="40" name="courseSave"  autocomplete="off" readonly="readonly">
 -->			</div>
		</div>
	  ...
	  layui.use('upload', function(){
		  ...
		  var uploadInst = upload.render({
			    ...
			    ,done: function(res){
			     ...
			     document.getElementsByName("courseSave")[0].text=res.data[0].src;
