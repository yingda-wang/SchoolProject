...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 4%;">
  <legend style="margin-left:40%;"><font color="blue" size="5">住院医师</font></legend>
</fieldset>
...
layui.use('table', function(){
  ...
  table.render({
    elem: '#LAY_table_user'
    ,url: 'rdoctor/search' //数据接口
    ,cols: [[ //表头
      {field: 'base', title: '住培基地', width:80, fixed: 'left'}
  ...
  ,layEvent = obj.event; //获得 lay-event 对应的值
   if(layEvent === 'del'){
    layer.confirm('真的删除行么', function(index){
  	  $.get("rdoctor/del", { phone: data.phone } );
        obj.del();
        layer.close(index);
        layer.msg("删除成功!");
