...
<body background="image/b5.jpg">
        ...
        <div class="container">
            <div class="navbar-header">
             ...
             <div align="right" style="margin-top: 20px" ><font  >欢迎您，尊敬的组长${user.name}</font></div>
	...
	<ul id="solutionList" class="clearfix">
		<li>
			<div class="solution-item-wrapper solution-item-01">
				...
				<p class="solution-title">组文件管理</p>
				
				<div class="short-bar"></div>
				<a href="/web/gfileSearch" class="common">查看详情</a>
		...
		<li  class="active">
			<div class="solution-item-wrapper solution-item-03">
				<p class="solution-title">岗位培训管理</p>
				<div class="short-bar"></div>
				<a href="/web/jobTrainInfo" class="common">查看详情</a>
			</div>
		</li>
		<li>
