...
<body background="image/b5.jpg">
        ...
        <div class="container">
            <div class="navbar-header">
             ...
             <div align="right" style="margin-top: 20px" ><font  >欢迎您，尊敬的物资质控员 ${user.name}</font></div>
	...
	<ul id="solutionList" class="clearfix">
		<li>
			<div class="solution-item-wrapper solution-item-01">
				...
				<p class="solution-title">物资管理</p>
				
				<div class="short-bar"></div>
				<a href="/web/managerWz" class="common" class="common" style="position:relative;top:223px;left:162px; text-decoration:none; color:white; font-size:16px; cursor:pointer;">物资管理</a>
				<a href="/web/managerWzType" class="common" class="common" style="position:relative;top:223px;left:162px; text-decoration:none; color:white; font-size:16px; cursor:pointer;">物资类别管理</a>
				<a href="/web/wzApplyInfo" class="common" class="common" style="position:relative;top:223px;left:162px; text-decoration:none; color:white; font-size:16px; cursor:pointer;">物资申请管理</a>
			</div>
		</li>
		...
		<li  class="active">
			<div class="solution-item-wrapper solution-item-03">
				<p class="solution-title">物资信息统计</p>
				<div class="short-bar"></div>
	            <a  href="/web/goodsCounts" class="common" style="position:relative;top:223px;left:162px; text-decoration:none; color:white; font-size:16px; cursor:pointer;">物资分配统计</a>
<!-- 				<a  href="###" class="common" style="position:relative;top:223px;left:162px; text-decoration:none; color:white; font-size:16px; cursor:pointer;">总物资统计</a>
				<a  href="###" class="common" style="position:relative;top:223px;left:162px; text-decoration:none; color:white; font-size:16px; cursor:pointer;">物资损耗统计</a>
 -->				</div>
		</li>
		<li>
