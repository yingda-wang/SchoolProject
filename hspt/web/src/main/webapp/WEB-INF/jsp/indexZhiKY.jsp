...
<body background="image/b5.jpg">
        ...
        <div class="container">
            <div class="navbar-header">
             ...
             <div align="right" style="margin-top: 20px" ><font  >欢迎您，尊敬的组质控员${user.name}</font></div>
	...
	<ul id="solutionList" class="clearfix">
		<li>
			<div class="solution-item-wrapper solution-item-01">
				...
				<p class="solution-title">组文件查询</p>
				
				<div class="short-bar"></div>
				<a href="/web/gfileSee" class="common">查看详情</a>
		...
		<li  class="active">
			<div class="solution-item-wrapper solution-item-03">
				<p class="solution-title">申请设备物资</p>
				<div class="short-bar"></div>
                <a  href="/web/deviceApplyAdd" class="common" style="position:relative;top:223px;left:162px; text-decoration:none; color:white; font-size:16px; ">设备申请</a>
				<a  href="/web/wzApply" class="common" style="position:relative;top:223px;left:162px; text-decoration:none; color:white; font-size:16px; cursor:pointer;">物资申请</a>
			</div>
		</li>
		<li>
			<div class="solution-item-wrapper solution-item-04">
				<p class="solution-title">组员出勤管理</p>
				<div class="short-bar"></div>
				
				<a href="#" class="common">未开放</a>
			</div>
		</li>
