...
layui.use('table', function(){
  ...
  table.render({
    elem: '#LAY_table_user'
    ,url: 'user/info' //controller
    ,cols: [[
      {checkbox: false, fixed: true, width:40}
      ,{field:'id', title: '工作证号ID', width:120, sort: true, fixed: true}
      ,{field:'name', title: '姓名',  width:80}
      ,{field:'sex', title: '性别',  width:50, }
      ,{field:'classes', title: '类别',  width:80}
      ,{field:'phone', title: '联系电话', width:100}
      ,{field:'chara', title: '性质',  width:80}
      ,{field:'duty', title: '行政职务', width:100}
      ,{field:'technical', title: '技术职务',  width:100}
      ,{field:'teacherPosition', title: '教学职务',  width:100}
      ,{field:'zName', title: '所属组',  width:100}
...
<form class="layui-form" action="user/updateDate" method="post" style="display:none;"   id="edit">
...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 4%;">
  <legend style="margin-left:40%;"><font color="blue" size="5">人员信息管理</font></legend>
</fieldset>
