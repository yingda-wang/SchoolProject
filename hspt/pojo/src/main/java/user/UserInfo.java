...
public void setTechnicalTime(String technicalTime) {
	this.technicalTime = technicalTime+"-00";
}
...
public void setTeacherTime(String teacherTime) {
	this.teacherTime = teacherTime+"-00";
}
...
public void setGraduateTime(String graduateTime) {
	this.graduateTime = graduateTime+"-00";
}
